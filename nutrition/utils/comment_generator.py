...
keyword_map = {
    ...
    "비타민 B6 함유": "비타민 B6가 함유되어 에너지 대사와 피로 회복에 도움을 줄 수 있어요.",
    "비타민 B6 풍부": "비타민 B6가 풍부해 신경 기능과 활력 유지에 유익합니다.",
    "비타민 B12 함유": "비타민 B12가 함유되어 신경 건강이나 혈액 생성에 도움을 줄 수 있어요.",
    "비타민 B12 풍부": "비타민 B12가 풍부해 채식 위주의 식단을 보완하는 데 유익합니다.",
    "비타민 C 함유": "비타민 C가 함유되어 피로 회복이나 면역력 강화에 좋습니다.",
    "비타민 C 풍부": "비타민 C가 풍부해 감기 예방이나 항산화에 도움을 줄 수 있어요.",
    "비타민 D 함유": "비타민 D가 함유되어 뼈 건강과 면역력 유지에 도움이 됩니다.",
    "비타민 D 풍부": "비타민 D가 풍부해 햇빛 부족이 걱정되는 분들께 좋습니다.",
    "비타민 E 함유": "비타민 E가 함유되어 있어 항산화 작용을 기대할 수 있어요.",
    "비타민 E 풍부": "비타민 E가 풍부해 노화 방지나 세포 보호에 관심 있는 분들께 유익합니다.",
    "비타민 K 함유": "비타민 K가 함유되어 뼈 대사와 혈액 응고에 도움이 될 수 있어요.",
    "비타민 K 풍부": "비타민 K가 풍부해 뼈 건강을 신경 쓰는 분들께 유익합니다.",
